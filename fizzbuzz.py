...
def fizzbuzz_summary(n):
    fizz_count, buzz_count, fizzbuzz_count = count_fizzbuzz(n)
    print(f"Total Fizz: {fizz_count}, Total Buzz: {buzz_count}, Total FizzBuzz: {fizzbuzz_count}")

if __name__ == "__main__":
    n = int(input("Enter a number up to which to run FizzBuzz: "))
    fizzbuzz(n)
